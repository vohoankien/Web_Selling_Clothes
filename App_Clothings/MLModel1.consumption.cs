...
namespace App_Clothings
{
    public partial class MLModel1
    {
        ...
        public class ModelInput
        {
            ...
            public string Nội_dung_đánh_giá { get; set; }

            [LoadColumn(2)]
            [ColumnName(@"Số sao")]
            public string Số_sao { get; set; }
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("Số sao");
            if (labelColumn == null)
            {
                throw new Exception("Số sao column not found. Make sure the name searched for matches the name in the schema.");
            }
