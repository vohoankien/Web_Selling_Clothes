...
namespace App_Clothings
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\VOHOANKIEN\Desktop\dataset.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"Số sao",inputColumnName:@"Số sao",addKeyValueAnnotationsAsText:false)      
                                    .Append(mlContext.MulticlassClassification.Trainers.TextClassification(labelColumnName: @"Số sao", sentence1ColumnName: @"Nội dung đánh giá"))      
